...
network_init(server *srv) {
	...
	*/
	...
	struct nb_map {
		...
		{ NETWORK_BACKEND_MTCP_OFFLOAD_WRITE,   "mtcp_offload_write" },
#endif		
...
# endif /* !OPENSSL_NO_TLSEXT */
	...
	case NETWORK_BACKEND_MTCP:
		...
		break;
	case NETWORK_BACKEND_MTCP_OFFLOAD_WRITE:
			srv->network_backend_write = network_write_chunkqueue_mtcp_offload_write;
		break;
#endif
	default:
		return -1;

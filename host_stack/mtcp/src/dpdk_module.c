...
#define MAX_PKT_BURST			1024 // 512 /*128*/

/*
 * Configurable number of RX/TX ring descriptors
 */
#define RTE_TEST_RX_DESC_DEFAULT	(1024*4)
#define RTE_TEST_TX_DESC_DEFAULT	(1024*4)
...
#elif RTE_VERSION < RTE_VERSION_NUM(21, 0, 0, 0)
